(function (global, factory) {
    ...
    (global = global || self, global.WFJSBridge = factory());
    ...
    ***************************************************************************** */
    ...
    var init = function () {
        if (window.WFJSBridge) {
            return;
        }
        /**
         * 处理 iframe 相关
         */
        var WFJSBridgeIframe = /** @class */ (function () {
            function WFJSBridgeIframe() {
            }
            /**
             * 分发消息
             * @param messageString
             */
            WFJSBridgeIframe.dispatchMessage = function (messageString) {
                // 处理有 iframe 的情况
             ...
             * 添加消息监听处理
             */
            WFJSBridgeIframe.addMessageListener = function () {
                ...
                window.addEventListener('message', function (e) {
                    ...
                    if (typeof data == "string") {
                        ...
                        if (str.indexOf("messageType") != -1) {
                            window.WFJSBridge._handleMessageFromNative(str);
                        }
                    }
                });
            };
             ...
             */
            WFJSBridgeIframe.setupHook = function () {
            ...
            return WFJSBridgeIframe;
        }());
        // iframe 内处理来自父 window 的消息
        WFJSBridgeIframe.addMessageListener();
        // 设置 iframe 的 sandbox 属性
        WFJSBridgeIframe.setupHook();
        /**
         * 建立与 native 的数据通信
         */
        var WFJSBridge = /** @class */ (function () {
            function WFJSBridge() {
                this.uniqueId = 1;
                this.callbackCache = {};
             ...
             * @param callback 调用回调
             */
            WFJSBridge.prototype.callNative = function (module, method, data, callback) {
                var message = {
                ...
                // 发送消息给 Native
                window.webkit.messageHandlers.webFast_JSBridge.postMessage(message);
            };
            /**
             * 用于处理来自 Native 的消息
             * @param callbackMessage 回调消息
             */
            WFJSBridge.prototype._handleMessageFromNative = function (messageString) {
                ...
                // 处理有 iframe 的情况
                WFJSBridgeIframe.dispatchMessage(messageString);
            };
            /**
             * 调用方法
             * @param module 模块
             ...
             * @param callback 调用回调
             */
            WFJSBridge.prototype.call = function (module, method, data, callback) {
             ...
             * @param callback 事件回调
             */
            WFJSBridge.prototype.on = function (eventName, callback) {
                // 使用数组，支持多个观察者
             ...
             * @param eventName 事件名字
             */
            WFJSBridge.prototype.off = function (eventName) {
                var obsevers = this.eventCallbackCache[eventName];
             ...
             * 模拟ajax请求
             */
            WFJSBridge.prototype._sendAjaxRequest = function () {
                const ajaxRequest = new XMLHttpRequest();
                ajaxRequest.onload = function() {};
                ajaxRequest.onerror = function() {};
                ajaxRequest.open('POST', 'https://m.baidu.com/app/get_company_introduction.json');
                ajaxRequest.setRequestHeader('Content-Type', 'application/json;charset=utf-8');
                ajaxRequest.setRequestHeader('Cookie', 'token=9658748593259684;uid=56987412;');
                ajaxRequest.send(JSON.stringify({name: 'Jack', age: 23}));
            };
            /**
             * 模拟fetch请求
             */
            WFJSBridge.prototype._sendFetchRequest = function () {
                const fetchRequest = new Request('https://m.baidu.com/app/find_user_info.json', {
                    method: 'POST',
                    body: JSON.stringify({
                        name: 'Alice',
                        age: 20
                    ...
                    headers: {
                        ...
                        'Cookie': 'token=9658748593259684;uid=56987412;'
                    }
                });
        ...
        // 初始化 WFJSBridge
        window.WFJSBridge = new WFJSBridge();
        /**
         * WFJSBridge配置
         */
        var WFJSBridgeConfig = /** @class */ (function () {
            function WFJSBridgeConfig() {
            }
            WFJSBridgeConfig.ajaxHook = false;
            /**
             * 开启 ajax hook
             */
            WFJSBridgeConfig.enableAjaxHook = function (enable) {
                if (enable) {
                    WFJSBridgeConfig.ajaxHook = true;
             ...
             * bridge Ready
             */
            WFJSBridgeConfig.bridgeReady = function () {
                window.WFJSBridge.call(_LIFECYCLE.moduleName, 'bridgeReady', {});
                // 告诉 H5 新的 WFJSBridge 已经 ready
                var WFJSBridgeReadyEvent = document.createEvent("Events");
                WFJSBridgeReadyEvent.initEvent("WFJSBridgeReady");
                document.dispatchEvent(WFJSBridgeReadyEvent);
            };
            return WFJSBridgeConfig;
        }());
        window.WFJSBridgeConfig = WFJSBridgeConfig;
        /**
         * WFJSBridge 工具
         */
        var WFJSBridgeUtil = /** @class */ (function () {
            function WFJSBridgeUtil() {
            }
            /**
              把 arraybuffer 转成 base64
            */
            WFJSBridgeUtil.convertArrayBufferToBase64 = function (arraybuffer) {
            ...
            WFJSBridgeUtil.convertFormDataToJson = function (formData, callback) {
                var _this = this;
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, WFJSBridgeUtil.convertFileToJson(value)];
                            case 2:
             ...
             * @param file
             */
            WFJSBridgeUtil.convertFileToJson = function (file) {
                return new Promise(function (resolve, reject) {
                    var reader = new FileReader();
         ...
         * 生命周期
         */
        var _LIFECYCLE = /** @class */ (function () {
            function _LIFECYCLE() {
            }
            // 静态属性和方法
            _LIFECYCLE.moduleName = 'lifeCycle';
            return _LIFECYCLE;
        }());
        window._LIFECYCLE = _LIFECYCLE;
        /**
                    ...
                    if (cookieDesc && cookieDesc.configurable) {
                        Object.defineProperty(document, 'cookie', {
                            ...
                            set: function (val) {
                                ...
                                window.WFJSBridge.call(_COOKIE.moduleName, 'setCookie', {
                                    "cookie": val
                                });
                            }
                        });
        ...
        var _XHR = /** @class */ (function () {
            ...
            _XHR.generateNewUrlWithRequestId = function (url, requestId) {
                ...
                if(url.indexOf('#') !== -1 && aTag.hash.length === 0) {
                    orignAction = url = url.replace('#', '');
                }
                var search = aTag.search ? aTag.search : "";
                var hash = aTag.hash ? aTag.hash : "";
                if (/WFJSBridge-RequestId/.test(orignAction)) { // 防止重复追加 requestId
                    aTag.search = aTag.search.replace(/WFJSBridge-RequestId=(\d+)/, "WFJSBridge-RequestId=" + requestId);
                }
                else if (aTag.search && aTag.search.length > 0) {
                    var s = aTag.search;
                    if (/WFJSBridge-RequestId/.test(s)) { // 防止重复追加 requestId
                        aTag.search = s.replace(/WFJSBridge-RequestId=(\d+)/, "WFJSBridge-RequestId=" + requestId);
                    }
                    else {
                        aTag.search = s + "&WFJSBridge-RequestId=" + requestId;
                    }
                }
                else {
                    aTag.search = "?WFJSBridge-RequestId=" + requestId;
                }
             ...
             */
            _XHR.isNonNormalHttpRequest = function (url, httpMethod) {
            ...
            _XHR.sendBodyToNativeForCache = function (targetType, target, originMethod, originArguments, request) {
                ...
                // 发送 body 请求到 native
                window.WFJSBridge.call(_XHR.moduleName, 'cacheAJAXBody', request, function (message) {
                    // 处理 native 侧缓存完毕后的消息
             ...
             * 安装 AJAX Proxy
             */
            _XHR.setupHook = function () {
                /**
                 * 只 hook open/send 方法
                 */
                var originOpen = XMLHttpRequest.prototype.open;
                XMLHttpRequest.prototype.open = function (method, url, async, username, password) {
                    console.log("发起了originOpen apply请求：", arguments);
                    ...
                    if (_XHR.isNonNormalHttpRequest(url, method)) { // 如果是非正常请求，则调用原始 open
                        return originOpen.apply(xhr, args);
                    }
                    if (!WFJSBridgeConfig.ajaxHook) { // 如果没有开启 ajax hook，则调用原始 open
                        return originOpen.apply(xhr, args);
                    }
                    // 生成新的 url
                ...
                XMLHttpRequest.prototype.send = function (body) {
                    console.log("发起了originSend.apply请求：", arguments);
                    var args = [].slice.call(arguments);
                    var xhr = this;
                    var request = {
                    ...
                    if (_XHR.isNonNormalHttpRequest(xhr.requestUrl, xhr.requestMethod)) { // 如果是非正常请求，则调用原始 send
                        return originSend.apply(xhr, args);
                    }
                    if (!WFJSBridgeConfig.ajaxHook) { // 如果没有开启 ajax hook，则调用原始 send
                        return originSend.apply(xhr, args);
                    }
                    if (!body) { // 没有 body，调用原始 send
                        ...
                        request.value = WFJSBridgeUtil.convertArrayBufferToBase64(body);
                    }
                        ...
                        WFJSBridgeUtil.convertFormDataToJson(body, function (json) {
                            request.value = json;
                            _XHR.sendBodyToNativeForCache("AJAX", xhr, originSend, args, request);
                        });
                        return;
                ...
                HTMLFormElement.prototype.submit = function () {
                    ...
                    if (!WFJSBridgeConfig.ajaxHook) { // 如果没有开启 ajax hook，则调用原始 submit
                    ...
                    WFJSBridgeUtil.convertFormDataToJson(formData, function (json) {
                        request.value = json;
    ...
    init(); // 初始化
    window.WFJSBridgeConfig.bridgeReady(); // JSBridge准备就绪
             
    var index = window.WFJSBridge;
    return index;
})));
